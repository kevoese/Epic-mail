const queries = {
  ...
  msgQuery: {
    ...
    getInbox: 'SELECT * FROM inbox WHERE user_id = $1 ORDER BY created_on DESC',
    ...
    getUnread: 'SELECT * FROM inbox WHERE (user_id = $1 AND read_status = \'unread\' ) ORDER BY created_on DESC',
    getRead: 'SELECT * FROM inbox WHERE (user_id = $1 AND read_status = \'read\' ) ORDER BY created_on DESC',
    getSent: 'SELECT * FROM sent WHERE (user_id = $1 AND status = \'sent\' ) ORDER BY created_on DESC',
    getDraft: 'SELECT * FROM sent WHERE (user_id = $1 AND status = \'draft\' ) ORDER BY created_on DESC',
    ...
    getFromInbox: 'SELECT * FROM inbox WHERE (message_id = $1) AND (user_id = $2) ORDER BY created_on DESC',
    getFromSent: 'SELECT * FROM sent WHERE (message_id = $1) AND (user_id = $2) ORDER BY created_on DESC',
