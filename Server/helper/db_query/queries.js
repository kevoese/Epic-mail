const queries = {
  ...
  msgQuery: {
    ...
    getSpecificMsg: 'SELECT inbox.id, created_on, user_id, sender_id, group_id, message_id, subject, message, read_status, parent_message_id, thread_id, email, firstname, lastname FROM inbox JOIN users ON inbox.sender_id = users.id WHERE (message_id = $1) AND (user_id = $2 OR sender_id = $2)',
    ...
    getFromInbox: 'SELECT inbox.id, created_on, user_id, sender_id, group_id, message_id, subject, message, read_status, parent_message_id, thread_id, email, firstname, lastname FROM inbox JOIN users ON inbox.sender_id = users.id WHERE (message_id = $1) AND (user_id = $2) ORDER BY created_on DESC',
    getFromSent: 'SELECT sent.id, created_on, user_id, receiver_id, group_id, message_id, subject, message, status, parent_message_id, thread_id, email, firstname, lastname FROM sent JOIN users ON sent.receiver_id = users.id WHERE (message_id = $1) AND (user_id = $2) ORDER BY created_on DESC',
